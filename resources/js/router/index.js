...
router.beforeEach((to, from, next) => {
  ...
  const publicPages = [
    ...
    'pairing-wheel', 'group-draw-wheel', 'public-live-score'
  ];

  if (!loginToken) {
    const onboardingWhitelist = ["onboarding", "privacy-policy", "tournament-landing", "pairing-wheel", "group-draw-wheel", "public-live-score"];
